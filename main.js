...
controls.zoomSpeed      = 5.0; // <-- ADD THIS LINE HERE
...
export function onARSessionStart() { milkyWaySphere.visible = false; }
export function onARSessionEnd()   { milkyWaySphere.visible = true;  }
